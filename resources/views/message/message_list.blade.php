...
<div class="in-content-wrap">
    ...
    <div class="in-search-box clearfix">
        <form action="{{ route('_messageList') }}" method="get">
            <select class="in-search-sel" name="type">
                <option value="title">标题</option>
                <option value="created_by">管理员</option>
            </select>
            <input type="text" value="{{ $keywords }}" name="keywords" class="in-search-input">
            ...
            <select class="in-search-sel" name="limit" >
                <option value="15" @if($page == 15) selected="selected" @endif>每15条</option>
                <option value="30" @if($page == 30) selected="selected" @endif>每页30条</option>
                <option value="50" @if($page == 50) selected="selected" @endif>每页50条</option>
                <option value="100" @if($page == 100) selected="selected" @endif>每页100条</option>
            </select>
    ...
    <table id="myTable" class="tablesorter table  table-bordered ">
        ...
        @forelse($data  as $d)
            <tr id="row_{{ $d->id }}">
                ...
                <td align="center" id="send_to{{ $d->id }}">{{ $send_to_arr[$d->send_to] }}</td>
                <td align="center">
