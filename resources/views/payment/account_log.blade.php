...
<div class="in-content-wrap">
    ...
    <div class="in-search-box clearfix">
        <select  class="in-search-sel aaa">
            ...
            {{--0:待审,1:锁定,2:成功,3:失败,4:回查成功,5:回查失败--}}
        </select>
    ...
    <table  id="myTable" class="tablesorter table  table-bordered ">
       ...
       @foreach ($res_change as $change)
            <tr class="change{{$change->id}}">
                <td align="center" style="display: none;">{{$change->id}}</td>
                <td align="center">{{$change->username}}</td>
                <td align="center">{{$change->type}}</td>
                <td align="center">{{$change->amount_change}}</td>
                <td align="center">{{$change->balance}}</td>
                <td align="center">{{$change->remark}}</td>
                <td align="center">{{$change->created_at}}</td>
            </tr>
        @endforeach
