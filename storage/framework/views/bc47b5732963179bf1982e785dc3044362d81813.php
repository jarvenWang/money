...
<div class="in-content-wrap">
    ...
    <div class="in-search-box clearfix">
        <form action="<?php echo e(route('_member-level')); ?>" method="get">
...
//            layer.alert($message);
    ...
    <div class="in-total-box">
        <a href="#" class="in-member-num">
            vip会员人数:<span><?php echo e(isset($vip) ? $vip : 0); ?></span>
        </a>
        <a href="#" class="in-member-num">
            在线会员人数:<span><?php echo e(isset($online) ? $online : 0); ?></span>
        </a>
        <a href="#" class="in-member-num">
            危险会员人数:<span><?php echo e(isset($danger) ? $danger : 0); ?></span>
        </a>
        <a href="#" class="in-member-num">
            会员总额:<span><?php echo e($counts); ?></span>
        </a>
    </div>
    <!--  //总计 -->
    <!-- 列表数据  -->
    <table id="myTable" class="tablesorter table  table-bordered ">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); $__empty_1 = false; ?>
            <tr>
                <td align="center" id="levelid<?php echo e($d->id); ?>"><?php echo e($d->id); ?></td>
                <td align="center" id="name<?php echo e($d->id); ?>"><?php echo e($d->name); ?></td>
                <td align="center" id="type<?php echo e($d->id); ?>"><?php echo e($type[$d->type]); ?></td>
                <td align="center" id="fandian<?php echo e($d->id); ?>"><?php echo e(isset($d->fandian) ? $d->fandian : 0); ?></td>
                <td align="center" id="fencheng<?php echo e($d->id); ?>"><?php echo e(isset($d->fencheng) ? $d->fencheng : 0); ?></td>

                <td align="center" id="payment_channel<?php echo e($d->id); ?>"><?php echo e($d->payment_channel); ?></td>
                <td align="center" id="allow_payment<?php echo e($d->id); ?>"><?php echo e($d->allow_payment); ?></td>
                <td align="center" id="url<?php echo e($d->id); ?>"><?php echo e($d->url); ?></td>
                <td align="center" id="total<?php echo e($d->id); ?>"><?php echo e($d->total); ?></td>
                <td align="center" id="allow_games<?php echo e($d->id); ?>"><?php echo e($d->allow_games); ?></td>
                ...
                <td align="center" id="updated_at<?php echo e($d->id); ?>"><?php echo e($d->updated_at); ?></td>
                <td align="center">
...
//            "created_by": _created_by
        ...
        var urls = "<?php echo e(route('_changeLevel')); ?>";
        $.ajax({
            type: 'get',
            url: urls,
            data: {"data": _data},
...
//        获取服务器传过来的第几页
        ...
        var counts =<?php echo e(isset($count) ? $count : 0); ?>;
        var urls = "<?php echo e(route('_member-level')); ?>";

        if (page != getPages) {
            $.ajax({
                type: 'get',
                url: urls,
                data: {'p': curr,'where_json':'<?php echo e(isset($where) ? $where : ''); ?>' },
...
//                        groups: 3,
    ...
    $(".editer-btn").on("click", function () {
        ...
        var urls = "<?php echo e(route('_selectLevel')); ?>";
        $.ajax({
            type: 'get',
            url: urls,
            data: {'editid': editid},
...
//            });
    ...
    function fm_add() {
        ...
        var urls = "<?php echo e(route('_addLevel')); ?>";
        $.ajax({
            type: 'post',
            url: urls,
            ...
            success: function (data) {
                ...
                if (data.status == 1) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: '<?php echo e(route('_member-level')); ?>',
                        dataType: "html",
                        success: function (data) {
                            $("#include-page").html(data);
