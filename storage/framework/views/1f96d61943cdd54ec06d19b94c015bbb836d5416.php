...
<script type="text/javascript">
    ...
    $("#check").click(function () {
        ...
        $.post('/search_member',{'_token':'<?php echo e(csrf_token()); ?>','username':username},function(data)
        {
            //console.info(data);
            if(data == 2){
                layer.msg('该用户名不存在');
    ...
    $("#sub").click(function () {
        ...
        if(type==1 || type==2) {
            ...
            $.post('/change_money',{'_token':'<?php echo e(csrf_token()); ?>','id':id,'balance':balance,'type':type,'remark':remark,'money':money},function(data)
            {
                console.info(data);
                if(data != 1){
                    layer.msg('操作成功');
