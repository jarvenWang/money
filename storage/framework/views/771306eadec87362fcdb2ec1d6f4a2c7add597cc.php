...
<div class="in-content-wrap">
    ...
    <div class="in-search-box clearfix">
        <form action="<?php echo e(route('_noticeList')); ?>" method="get">
            <select class="in-search-sel">
                <option>标题</option>
            </select>
            <input type="text" value="<?php echo e($title); ?>" name="title" class="in-search-input">
    ...
    <table id="myTable" class="tablesorter table  table-bordered ">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); $__empty_1 = false; ?>
            <tr id="row_<?php echo e($d->id); ?>">
                ...
                <td align="center" id="deleted_at<?php echo e($d->id); ?>"><?php echo e($d->deleted_at); ?></td>
                <td align="center" id="display_where<?php echo e($d->id); ?>"><?php echo e($display_where[$d->display_where]); ?></td>
                <td align="center" id="display_type<?php echo e($d->id); ?>"><?php echo e($display_type[$d->display_type]); ?></td>
                <td align="center">
                    ...
                    <div class="com-form-group clearfix">
                        ...
                        <div class="com-form-r com-fl">
                            <select class="com-select" id="fm_display_where" name="data[display_where]">
                                <?php $__currentLoopData = $display_where; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dw): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <option value="<?php echo e($key); ?>" ><?php echo e($dw); ?></option>
                    ...
                    <div class="com-form-group clearfix">
                        ...
                        <div class="com-form-r com-fl">
                            <select class="com-select" id="fm_display_type" name="data[display_type]">
                                <?php $__currentLoopData = $display_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dt): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <option value="<?php echo e($key); ?>" ><?php echo e($dt); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function fm_submit() {
        ...
        var urls = "<?php echo e(route('_changeNotice')); ?>";
        $.ajax({
            type: 'get',
            url: urls,
            data: {"data": _data},
...
//        获取服务器传过来的第几页
        ...
        var urls = "<?php echo e(route('_noticeList')); ?>";
        if (page != getPages) {
            $.ajax({
                type: 'get',
                url: urls,
    ...
    $(".editer-btn").on("click", function () {
        ...
        var urls = "<?php echo e(route('_selectNotice')); ?>";
        $.ajax({
            type: 'get',
            url: urls,
            data: {'editid': editid},
    ...
    $(".del-btn").on("click", function () {
        ...
        var urls = "<?php echo e(route('_delNotice')); ?>";
        layer.confirm('确认删除？', {
            btn: ['确认', '取消'] //按钮
        }, function () {
            $.ajax({
    ...
    function fm_add() {
        ...
        var urls = "<?php echo e(route('_addNotice')); ?>";
        $.ajax({
            type: 'post',
            url: urls,
            ...
            success: function (data) {
                if (data.status == 1) {
                    layer.close(_add);
                    $.get(
                            '<?php echo e(route('_noticeList')); ?>','',function(d){
                                $("#include-page").html(d);
                            }
                    );
                }
