...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
         ...
         * mobile : 手机号码 6
         * balance : 帐户余额 7
         * frozen_balance : 帐户被冻结金额 8
         * frozen_login_time : 帐户冻结登陆时间,在此时间之前帐户无法登陆
         * fandian : 代理反水设置
         * status : 帐户状态(1:正常,0:关闭) 9
         * remark : 备注信息
         ...
         * total_cash : 提款次数
         * online : 在线状态(1:在线, 0:离线) 10
         * created_ip : 创建时IP地址 11
         * last_login_ip : 最后登陆IP地址 12
         * last_login_at : 最后登陆时间 13
         * last_lgin_address : 最后登陆所在地 14
         * number : 会员号(预留)
         * amount_cash : 提款金额
         * amount_hongli : 红利金额
         * */
